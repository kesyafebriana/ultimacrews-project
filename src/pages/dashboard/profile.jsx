        ...
        <CardBody className="p-4">
          <div className="mb-10 flex items-center justify-between gap-6">
            <div className="flex items-center gap-6">
              <div>
                <img
                  src={"https://backend-ultimacrews-project.vercel.app/images/"+profile.image}
              ...
              <div>
                ...
                <div className="grid text-sm md:grid-cols-2">
                  <div class="grid grid-cols-2">
                    ...
                    <div class="px-4 py-2">{profile.username}</div>
                  </div>
                  <div class="grid grid-cols-2">
                ...
                <div className="grid text-sm md:grid-cols-2">
                  <div class="grid grid-cols-2">
                    ...
                    <div class="px-4 py-2">{profile.nomorTelp}</div>
                  </div>
                  <div class="grid grid-cols-2">
                    <div class="px-4 py-2 font-semibold">Line ID</div>
                    <div class="px-4 py-2">{profile.lineId}</div>
                  </div>
                  <div class="grid grid-cols-2">
